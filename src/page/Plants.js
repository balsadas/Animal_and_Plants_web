                    ...
                    <ul className="grid md:grid-cols-3 lg:grid-cols-4">
                        {Cat.map((cat, index) => (
                            <Link to='/IntoPlants'>
                                ...
                                >
                                    <li key={index} className="bg-[#ffffffac]  hover:bg-[#92d280] group cursor-pointer select-none mx-3 my-2 shadow-lg duration-300 ease-in-out  rounded-lg p-2 md:hover:scale-110">
                                        <img src="./img/plants4.jpg" className="lg:w-[20vw]   h-[60vw] w-full md:h-[15vw] object-cover rounded-lg" />
                                        <p className=" p-2 md:text-[1.5vw] font-[500] text-[5vw] group-hover:text-[#fff]">{cat.title}</p>
