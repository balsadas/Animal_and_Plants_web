                ...
                <Link to='/Animals'>
                    <div className="md:hover:scale-110 translate-y-1 transition-all ease-in-out duration-150">
                        <motion.div
                            ...
                            <div className="pt-2 items-center text-[6vw]  flex justify-center md:text-[2.5vw] font-[500] group-hover:text-[green] ">Animals</div>
                        </motion.div>
                    </div>
                </Link>
                <Link to='/Plants'>
                    <div className=" md:hover:scale-110 translate-y-1 transition-all ease-in-out duration-150">
                        <motion.div
                            ...
                            <div className="pt-2 text-[6vw] flex justify-center md:text-[2.5vw] font-[500] group-hover:text-[green] ">Plants</div>
                        </motion.div>
                    </div>
                </Link>
            </div>
